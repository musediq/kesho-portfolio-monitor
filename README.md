...
**Live prototype:** `https://musediq.github.io/kesho-portfolio-monitor/AfriCapital_Pro__standalone_.html`

## What's in here

| # | Deliverable | File |
|---|---|---|
| 1 | Working prototype | [`AfriCapital_Pro__standalone_.html`](./AfriCapital_Pro__standalone_.html), |
